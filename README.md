...
<h1 align="center">🏢 Rahmat Manzil Society Management System</h1>
...
A complete society management solution for **Rahmat Manzil** housing society (~40 flats). Built with modern technologies, this system streamlines daily operations including:
...
3. **Configure environment variables**
   ...
   **Client** (`client/.env.local`):
   ...
   NEXT_PUBLIC_IMAGEKIT_PUBLIC_KEY=public_0qzXtubYzOJ32vMRdaAE42sT8DE=
   NEXT_PUBLIC_IMAGEKIT_URL_ENDPOINT=https://ik.imagekit.io/pw9m5xbcz
   ```
