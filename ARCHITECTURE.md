# Architecture: Rahmat Manzil Society Management System

## Overview

A full-stack society management web application for **Rahmat Manzil** housing society (~40 flats). The system handles maintenance collection via Razorpay (₹1000/month + ₹100 late fee), lift emergency alerts via email, complaints with image uploads, asset tracking, and a dedicated watchman portal. Built with Next.js 14 + Express.js + MongoDB, deployed on Vercel + Render.
...
```
Subject: 🏠 Maintenance Due - {Month} {Year} | Rahmat Manzil
...
Regards,
Rahmat Manzil Society
```

### 2. Payment Reminder (Day 10)
```
Subject: ⏰ Reminder: Maintenance Payment Pending | Rahmat Manzil
...
```
Subject: ⚠️ Final Notice: Pay Before Late Fee Applies | Rahmat Manzil
...
```
Subject: ✅ Payment Received - Thank You! | Rahmat Manzil
...
```
Subject: 🚨 LIFT EMERGENCY - Rahmat Manzil
...
---
This is an automated alert from Rahmat Manzil Society Management System.
```

### 6. Emergency Resolved
```
Subject: ✅ Lift Emergency Resolved | Rahmat Manzil
...
```
Subject: 🔐 Password Reset OTP | Rahmat Manzil
...
```
Subject: 📋 Complaint Status Updated | Rahmat Manzil
...
BREVO_SENDER_NAME=Rahmat Manzil Society
...
This architecture document provides a comprehensive blueprint for building the Rahmat Manzil Society Management System. All major decisions have been documented with rationale, and the system is designed for future extensibility.
